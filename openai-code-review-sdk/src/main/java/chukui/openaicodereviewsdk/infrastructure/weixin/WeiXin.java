package chukui.openaicodereviewsdk.infrastructure.weixin;
...
public class WeiXin {
    ...
    public void sendTemplateMessage(String logUrl, Map<String, Map<String, String>> data) throws Exception {
        ...
        URL url = new URL(String.format("https://api.weixin.qq.com/cgi-bin/message/template/send?access_token=%s",
                accessToken));
